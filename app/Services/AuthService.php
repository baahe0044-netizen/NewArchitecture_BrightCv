...
final class AuthService
{
    ...
    public function login(string $email, string $password, string $ip, bool $remember = false): array
    {
        ...
        (new ActivityRepository())->record((int) $user['id'], 'signed_in', 'Signed in to ' . APP_NAME);
    ...
    public function register(array $data): array
    {
        ...
        (new ActivityRepository())->record($id, 'account_created', 'Created a ' . APP_NAME . ' account');
    ...
    public function requestPasswordReset(string $email): void
    {
        ...
        $html = '<p>Hello ' . e($user['name']) . ',</p>'
            . '<p>Use the secure link below to reset your ' . e(APP_NAME) . ' password. It expires in 30 minutes.</p>'
